...
(function (global) {
  ...
  var I18N_EN = {
    ...
    'trial_capture.placeholder_phone': 'E.g. +52 55 1234 5678',
    ...
    'onboarding.otro.title': 'How ARPA Suite works',
    'onboarding.otro.text_intro': "You'll fill out this form on-site, from your phone.",
    'onboarding.otro.item1': '📋 Fill in the service details — takes 2 minutes',
    'onboarding.otro.item2': '📄 Generate the professional PDF instantly',
    'onboarding.otro.item3': '💬 Share it on WhatsApp or save it — free for the first 7 days',
    'onboarding.otro.btn_continue': 'Got it, let\'s start →',
    ...
    'header.doc_type.inicio': 'Home',
    'header.doc_type.formato': 'Work',
    ...
    'header.doc_type.ia_tecnica': 'Technical AI',
    'header.doc_type.ia_copiloto': 'ARPA IA',
    'header.doc_type.ia_integral': 'ARPA IA',
    ...
    'menu.cuenta_cobro': 'Invoices',
    'menu.configuracion': 'Settings',
    'menu.fab_add.aria': 'Add',
    'simple.hola': 'Hello',
    'simple.hola_nom': 'Hello, {name}',
    'simple.ia.pregunta': 'What do you need to do?',
    'simple.ia.placeholder': 'Type what you need…',
    'simple.ia.continuar': 'Continue',
    'simple.ia.vacio': 'Write what you need to do.',
    'simple.ia.aclaracion': 'Do you want to create a job, quote, or look up something already saved?',
    'simple.ia.sin_consulta': 'Could not look that up. No data was invented.',
    'simple.ia.sin_datos': 'There is no data for that query.',
    'simple.hoy': 'Today',
    'simple.hoy_vacio': 'You have no jobs for today.',
    'simple.acciones': 'Quick actions',
    'simple.btn.trabajo': 'New job',
    'simple.btn.cotizar': 'Quote',
    'simple.reciente': 'Recent',
    'simple.reciente_vacio': 'No recent documents yet.',
    'simple.sin_cliente': 'No client',
    'simple.borrador': 'Draft',
    'simple.kind.trabajo': 'Job',
    'simple.kind.cot': 'Quote',
    'simple.kind.cc': 'Invoice',
    'simple.problema.titulo': 'What do you need to do?',
    'simple.problema.placeholder': 'Describe the job or the problem. E.g. The BFT door will not close.',
    'simple.pasos.estado': 'Step {n} of {total} · {nombre}',
    'simple.pasos.todos': 'All fields',
    'simple.pasos.ver_todos': 'Show all fields',
    'simple.pasos.por_pasos': 'Show step by step',
    'simple.pasos.continuar': 'Continue',
    'simple.pasos.atras': 'Back',
    'simple.pasos.listo': 'Done',
    'simple.mas.titulo': 'More',
    'simple.mas.cerrar': 'Close',
    ...
    'formato.placeholder.telefono': 'Contact number',
    ...
    'oficio.taller_motos': 'Motorcycle Workshop',
  ...
  var DOC_TYPE_KEYS = {
    ...
    'ia-tecnica': 'header.doc_type.ia_tecnica',
    'ia-copiloto': 'header.doc_type.ia_copiloto',
    'ia-integral': 'header.doc_type.ia_integral'
  };
  ...
  function supplementSpanishKeys() {
    Object.assign(I18N_ES, {
      'header.doc_type.inicio': 'Inicio',
      'header.doc_type.formato': 'Trabajo',
      'header.doc_type.cotizacion': 'Cotización',
      'header.doc_type.catalogo': 'Mi Catálogo',
      'header.doc_type.cuenta_cobro': 'Cuenta de Cobro',
      'header.doc_type.historial': 'Historial',
      'header.doc_type.ia_tecnica': 'IA Técnica',
      'header.doc_type.ia_copiloto': 'ARPA IA',
      'header.doc_type.ia_integral': 'ARPA IA',
      'menu.inicio': 'Inicio',
      'menu.trabajos': 'Trabajos',
      'menu.cotizar': 'Cotizar',
      'menu.mas': 'Más',
      'simple.hola': 'Hola',
      'simple.hola_nom': 'Hola, {name}',
      'simple.ia.pregunta': '¿Qué necesitas hacer?',
      'simple.ia.placeholder': 'Escribe aquí lo que necesitas…',
      'simple.ia.continuar': 'Continuar',
      'simple.ia.vacio': 'Escribe qué necesitas hacer.',
      'simple.ia.aclaracion': '¿Quieres crear un trabajo, cotizar o consultar algo ya guardado?',
      'simple.ia.sin_consulta': 'No se pudo consultar. No se inventaron datos.',
      'simple.ia.sin_datos': 'No hay datos para esa consulta.',
      'simple.hoy': 'Hoy',
      'simple.hoy_vacio': 'No tienes trabajos para hoy.',
      'simple.acciones': 'Acciones rápidas',
      'simple.btn.trabajo': 'Nuevo trabajo',
      'simple.btn.cotizar': 'Cotizar',
      'simple.reciente': 'Reciente',
      'simple.reciente_vacio': 'Aún no hay documentos recientes.',
      'simple.sin_cliente': 'Sin cliente',
      'simple.borrador': 'Borrador',
      'simple.kind.trabajo': 'Trabajo',
      'simple.kind.cot': 'Cotización',
      'simple.kind.cc': 'Cuenta de cobro',
      'simple.problema.titulo': '¿Qué necesitas hacer?',
      'simple.problema.placeholder': 'Describe el trabajo o el problema. Ej. La puerta BFT no cierra.',
      'simple.pasos.estado': 'Paso {n} de {total} · {nombre}',
      'simple.pasos.todos': 'Todos los campos',
      'simple.pasos.ver_todos': 'Ver todos los campos',
      'simple.pasos.por_pasos': 'Ver por pasos',
      'simple.pasos.continuar': 'Continuar',
      'simple.pasos.atras': 'Atrás',
      'simple.pasos.listo': 'Listo',
      'simple.mas.titulo': 'Más',
      'simple.mas.cerrar': 'Cerrar',
      ...
      'formato.titulo.taller_motos': 'Tipo de Servicio de Moto',
      'oficio.taller_motos': 'Taller de motos',
